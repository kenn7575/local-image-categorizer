...
import { CalendarDays, Compass, Flag, GalleryHorizontalEnd, Rocket, RotateCcw, RotateCw, Sparkles, Upload } from "lucide-react";
...
const steps = [
  ...
  },
  {
    title: "Load model",
    description:
      "Our AI model loads automatically to prepare for image classification.",
    icon: Rocket,
    time: "Step 2",
    status: ProcessStep.IMPORTING,
  },
      ...
      <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[1.05fr_1fr]">
        ...
        >
          ...
          <div className="relative">
              ...
              <p className="max-w-xl text-base leading-relaxed text-foreground/70 md:text-lg">
                Streamline your workflow with our intuitive image classification
                tool. Upload multiple images at once, let our AI classify them,
                and organize your gallery effortlessly.
              </p>
            </div>
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              ...
              disabled={status !== ProcessStep.BEFORE_UPLOAD}
                size="lg"
                className={cn("h-12 rounded-full px-8 text-sm uppercase tracking-[0.2em] cursor-pointer", status !== ProcessStep.BEFORE_UPLOAD && "opacity-50 cursor-not-allowed")}
                onClick={onClick}
              >
                Upload images
                {status !== ProcessStep.BEFORE_UPLOAD && (
        ...
        >
          ...
          <div className="relative">
              ...
              <p className="max-w-xl text-base leading-relaxed text-foreground/70 md:text-lg">
                Your images have been successfully classified and sorted. Click
                the button below to review and make any necessary adjustments.
              </p>
            </div>
